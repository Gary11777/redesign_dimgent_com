...
<html lang="en">
<head>
	<title>Dimgent Technologies contacts</title>
	<meta charset="utf-8" />
	<meta name="description" content="Dimgent Technologies Development Center: Minsk, Belarus.
	Phone (Office in Poland): +48 57 702 83 35" />
...
<!-- Select country (part 1 of 2) -->
	<link rel="stylesheet" href="country/country.css" />
	<script src="country/jquery-1.11.1.min.js"></script>
	<script src="country/jquery-ui.min.js"></script>
	<script src="country/jquery.select-to-autocomplete.js"></script>
	<script>
	  (function($){
	    $(function(){
...
<body>
<!-- Begin of div for all other divs -->
<div id="conteiner">
...
<div id="header">
	<div id="mainmenu">
	<ul>
		<li><img src="pic/logo.png" alt="Logo of Dimgent Technologies" class="logo" /></li>
...
<div id="conteiner-inner">
	
	
	<!-- Begin of right column -->
	<div id="left">
		<div>
		<h4 class="top">«Dimgent Technologies» is:</h4>
		<ul>
		...
		<li class="link"><a href="about.html">And more...</a></li>
		</ul>
		</div>
		<div>
		<h4 class="top">We can provide:</h4>
		<ul>
		...
		<li class="link"><a href="services.html">And more…</a></li>
		</ul>
		</div>
	</div>
	<!-- End of right column -->
	
	<!-- Begin of column Контакты -->
 	<div id="content">
		<h2 class="head">Contacts</h2>
		<p class="center">For more information, please contact:</p>
		<p class="center"><strong>+48 57 702 83 35</strong></p>
		<p class="center">Office in Poland</p>
        <p class="center">or email us on:<img src="pic/mail_white.png" alt="E-mail Dimgent Technologies" class="mail" /></p>
        <hr />
<?php
...
$subject = "Message from dimgent.com";
$message = "Name: $name \nСтрана: $country \nTel: $phone \nE-mail: $email \nMessage: $mess";
$send = mail ($to, $subject, $message, $headers);
if ($send == 'true')
{
echo "<h3 class='center'><font color='#cd0000'><b>Your message has been successfully sent! Thank you!</b></font></h3>";
}
else 
{
echo "<h3 class='center'><font color='#cd0000'><b>Error. Please, try again.</b></font></h3>";
}
?>
	  <form action="mail.php" name="contact" method="post">
	  <table class="tablecontact">
		<tr>
			<td>Your name <span class="star">*</span></td>
			<td><input type="text" required name="name" class="contactform" />
			</td>
		</tr>
		<tr>
		<td>Country</td>
		<td>
<!-- Select country (part 2 of 2) -->
	<select name="country" id="country-selector" class="contactform" autofocus="autofocus" autocorrect="off" autocomplete="off">
      ...
      <option value="China" data-relevancy-booster="1.5" data-alternative-spellings="CN Zhongguo Zhonghua Peoples Republic 中国/中华">China</option>
      ...
      <option value="Poland" data-alternative-spellings="PL Polska Poland" data-relevancy-booster="3.5">Polska</option>
 ...
 <!-- Select country (part 2 of 2) -->		
		...
		<tr>
			...
			<td><input type="tel" name="phone" class="contactform" />
			</td> 
		</tr>
		<tr>
			<td>E-mail <span class="star">*</span></td>
			<td><input type="email" required name="email" class="contactform" />
			</td> 
		</tr>
		<tr>
			<td class="mess">Message <span class="star">*</span></td>
			<td><textarea name="mess" required id="message"></textarea></td>    
		</tr>
		<tr>
			<td></td>
	...
	<!-- End of column Контакты -->
	
	<!-- Begin of content2 column
	<div id="content2">
		
	</div>
	End of content2 column -->
	
 	<!-- <div id="footer">Footer</div> --> <!-- Этот блок на две колонки -->
</div>
<!-- End of content block -->

<!-- Begin of bottom block -->
<div id="conteiner-bottom">
	<div id="bottom">
		<div id="bottom1">
		<p>// Dimgent Technologies</p>
		<p>Electronics Development</p>
		<!-- <p>Phone (Office in Poland):</p>
		<ul class="bottom">
			<li>+48 57 702 83 35</li>
		</ul> -->
		<p>E-mail:</p>
		<ul class="bottom">
			<li><img src="pic/mail_bottom.png" alt="E-mail Dimgent Technologies" class="mail" /></li>
		</ul>
		<p>Minsk, Belarus</p>
		</div>
		<div id="bottom2">
		...
		<div id="bottom3">
			<div id="bottom3inside">
			<p><a href="http://www.sitestar.by" class="bottom">Website design by Sitestar.by</a></p>
			</div>
		</div>
	</div>
</div>
